      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            <h3 className="text-2xl font-bold mb-3">
              Mark<span className="text-gradient">yDev</span>
            </h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              Premium websites and automation for businesses that want to grow.
            </p>
          </motion.div>
          ...
          >
            <h4 className="font-semibold text-sm mb-4 text-zinc-200">Quick Links</h4>
          ...
          >
            <h4 className="font-semibold text-sm mb-4 text-zinc-200">Connect</h4>
            <div className="flex gap-3 mb-6">
              {socials.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-10 h-10 rounded-xl glass flex items-center justify-center hover:border-orange-500/30 transition-colors"
                >
            ...
            <div className="flex flex-wrap gap-2">
              <span className="text-xs bg-zinc-800/60 border border-zinc-700/50 rounded-full px-3 py-1 text-zinc-400">
                🇵🇭 Philippines
              </span>
              <span className="text-xs bg-zinc-800/60 border border-zinc-700/50 rounded-full px-3 py-1 text-zinc-400">
                🇺🇸 United States
        ...
        <div className="border-t border-zinc-800/50 pt-6 text-center">
          <p className="text-zinc-500 text-xs">
            © 2026 MarkyDev. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
